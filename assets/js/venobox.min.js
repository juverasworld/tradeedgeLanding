!function(e, t) {
    ...
    */
    ...
    function J() {
        return !(!r || !document.body.classList.contains("vbox-open")) && ((!r.settings.onPreClose || "function" != typeof r.settings.onPreClose || !1 !== r.settings.onPreClose(r, p, j, H)) && (document.body.removeEventListener("keydown", te),
    ...
    function oe() {
        ...
        a.addEventListener("mousemove", le, !1)) : (a.classList.remove("vbox-grab"),
    ...
    function se(e, t, o) {
        ...
        if ("vimeo" == s.type || "youtube" == s.type) {
            ...
            "vimeo" == s.type ? i = "https://player.vimeo.com/video/" : "youtube" == s.type && (i = "https://www.youtube-nocookie.com/embed/"),
            x = '<div class="venoratio venoratio-' + t + '"><iframe webkitallowfullscreen mozallowfullscreen allowfullscreen allow="autoplay" frameborder="0" src="' + i + s.id + a + '"></iframe></div>'
        } else
            n = o ? " autoplay" : "",
    ...
    function re(e) {
        if (Y) {
            ...
            X > 0 && w && (e = H,
            t = !0),
            Math.abs(X) >= 50 && t ? ue(e) : (a.style.marginLeft = 0,
            a.style.opacity = 1)
        }
    }
    function le(e) {
    ...
    function de(e) {
        ...
        !H && m && (H = f[f.length - 1]),
        f.length >= 1 ? (p = l + 1,
        t.innerHTML = p + " / " + f.length) : p = 1,
        h ? t.classList.remove("vbox-hidden") : t.classList.add("vbox-hidden"),
        "" !== I ? n.classList.remove("vbox-hidden") : n.classList.add("vbox-hidden"),
        n.innerHTML = I,
        w = !1,
        L = !1,
        (j || m) && (L = !0),
    ...
    function be(l) {
        return !(document.body.classList.contains("vbox-open") || !l) && ((!l.settings.onPreOpen || "function" != typeof l.settings.onPreOpen || !1 !== l.settings.onPreOpen(l)) && (G(l),
